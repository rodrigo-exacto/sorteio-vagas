...
export const GRUPO_UNICO = "GERAL";
...
export function serializePayload(spec) {
  const L = [CABECALHO];
...
export function parsePayload(texto) {
 ...
 */
export function assertCanonico(texto) {
...
export async function commit(payloadTexto) {
 ...
 */
export async function derivarSemente(commitBytes, beaconValor) {
 ...
 */
export function normalizarLoteriaFederal(premios) {
...
export const FONTES = ["LOTERIA_FEDERAL", "DRAND_QUICKNET"];

/** Número da rodada quicknet vigente em um instante (ms desde a época). */
export function rodadaDrandEm(instanteMs) {
...
export function urlDaRodada(rodada) {
...
export function normalizarDrand(rodada, aleatorio) {
...
export function fonteDoBeacon(declaracao) {
...
export function rodadaDeclarada(declaracao) {
 ...
 */
export function validarBeacon(declaracao, valor, congeladoEm) {
...
export async function uniforme(prng, n) {
...
export async function embaralhar(lista, prng) {
  const a = lista.slice();
 ...
 */
export async function sortear(payloadTexto, beaconValor) {
...
export function serializarResultado(atribuicoes, semVaga) {
